            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  maxLength={25}
                  className="w-full bg-neutral-950/80 border border-white/5 focus:border-accent-blue/40 focus:ring-1 focus:ring-accent-blue/30 rounded-xl px-4 py-2.5 text-sm text-white placeholder-neutral-600 outline-none transition-all duration-200 font-sans"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-neutral-950/80 border border-white/5 focus:border-accent-blue/40 rounded-xl px-4 py-2.5 text-sm text-white outline-none appearance-none transition-all duration-200 cursor-pointer font-sans"
                  >
